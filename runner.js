...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function N(e, t) {
        ...
        for (var r in o)
            for (var a in o[r])
                o[r][a] || n.push("(p: " + r + " l: " + a + ")");
        return !(n.length > 0) || (console.log("%cdetectNetwork was NOT invoked with a card number that has the (prefix, length) combination(s):%c \n" + n.join("\n") + "%c\nSee below for more information.", "font-style: italic; background-color: pink;", "font-style: italic; background-color: pink; font-weight:bold", "font-style: italic; background-color: pink; font-weight:normal"),
        !1)
    }
    function S(e) {
